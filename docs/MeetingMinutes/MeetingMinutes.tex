...
\title{Meeting 0 Minutes\\\progname}
...
\begin{itemize}
    ...
    \item \hyperref[sec:meetingTime]{Next Meeting Time}
\end{itemize}
\section{Project List:}
\subsection{Rhombichess:}
\label{subsec:chess}
\begin{itemize}
    \item Description:
    \begin{itemize}
...
\hline
\end{tabularx}
\section{Next Meeting Time:}
\label{sec:meetingTime}
\begin{tabularx}{0.8\textwidth} { 
  | >{\raggedright\arraybackslash}X 
  | >{\centering\arraybackslash}X 
  | >{\raggedleft\arraybackslash}X | }
